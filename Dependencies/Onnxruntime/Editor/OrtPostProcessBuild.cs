...
namespace Microsoft.ML.OnnxRuntime.Editor
{
    ...
    {
        private const string PACKAGE_ID = "io.uglabs.unity.sdk";
        private const string PACKAGE_PATH = "Packages/io.uglabs.unity.sdk";
        private const string FRAMEWORK_SRC = "Dependencies/Onnxruntime/Plugins/iOS~/onnxruntime.xcframework";
